...
(defvar groovy-program-name "startGroovy org.codehaus.groovy.tools.shell.Main"
...
\(Type \\[describe-mode] in the process buffer for a list of commands.)"
  ...
  (if (not (comint-check-proc "*groovy*"))
	...
	(message cmdlist)
	(set-buffer (apply 'make-comint "goovy" "C:\\cygwin\\home\\nealm\\.gvm\\groovy\\2.3.4\\bin\\startGroovy" nil (list "org.codehaus.groovy.tools.shell.Main")))
;	(set-buffer (apply 'make-comint "groovy" (car cmdlist) nil (cdr cmdlist)))
